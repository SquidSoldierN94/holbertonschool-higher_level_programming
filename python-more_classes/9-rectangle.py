...
class Rectangle:
    ...
    number_of_instances : int
        The number of Rectangle instances (public class attribute).
    print_symbol : any
        The symbol used to print the rectangle (public class attribute).
    """
    ...
    def square(cls, size=0):
        ...
        -----------
        size : int, optional
            The size of the width and height of the new rectangle (default is 0).
